...
globalThis.openNextVersion = '3.10.1';

// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.19.1_next@14.2.15_@playwright+test@1.59.1_react-dom@18.3.1_rea_7e57afc53c0b893a9f2bae1ce85f574f/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/sharded-tag-cache.js
import { DurableObject } from 'cloudflare:workers';

// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.19.1_next@14.2.15_@playwright+test@1.59.1_react-dom@18.3.1_rea_7e57afc53c0b893a9f2bae1ce85f574f/node_modules/@opennextjs/cloudflare/dist/api/cloudflare-context.js
var cloudflareContextSymbol = Symbol.for('__cloudflare-context__');

// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.19.1_next@14.2.15_@playwright+test@1.59.1_react-dom@18.3.1_rea_7e57afc53c0b893a9f2bae1ce85f574f/node_modules/@opennextjs/cloudflare/dist/api/overrides/internal.js
...
var DOShardedTagCache = class extends DurableObject {
  ...
  async getLastRevalidated(tags) {
    ...
    const timeMs =
      values.length === 0 ? 0 : Math.max(...values.map(({ revalidatedAt }) => revalidatedAt));
  ...
  async getRevalidationTimes(tags) {
    const data = await this.getTagData(tags);
    return Object.fromEntries(
      Object.entries(data).map(([tag, { revalidatedAt }]) => [tag, revalidatedAt]),
    );
  }
