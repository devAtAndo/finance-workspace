...
// ../../node_modules/.pnpm/@opennextjs+cloudflare@1.19.1_next@14.2.15_@playwright+test@1.59.1_react-dom@18.3.1_rea_7e57afc53c0b893a9f2bae1ce85f574f/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          'x-prerender-revalidate': '0a1621982f6ad4866554126339c883d0',
          'x-isr': '1',
        },
  ...
  async initState() {
    ...
    this.sql.exec('DELETE FROM failed_state WHERE buildId != ?', 'o5Rcx4d08tD5Q4hVHgUPy');
    this.sql.exec('DELETE FROM sync WHERE buildId != ?', 'o5Rcx4d08tD5Q4hVHgUPy');
